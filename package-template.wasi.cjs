...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  const __wasiPackageEntry = require.resolve('@napi-rs/package-template-pnpm-wasm32-wasi')
  ...
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@napi-rs/package-template-pnpm-wasm32-wasi is installed but is missing package-template.wasm32-wasi.wasm.',
    )
  }
